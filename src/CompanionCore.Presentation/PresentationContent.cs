...
/// and for Stage 13's later Builder-phase replacement to key off) plus an expression intent.
/// <see cref="IPresentationSink"/> renders this without interpreting it further.
/// </summary>
public sealed record PresentationContent(
    string ContentKey,
    ExpressionIntent Intent,
    string? NeutralDetail = null);
